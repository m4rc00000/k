...
<head>
    ...
    <script>
        function validateInput(event) {
            var invalidChars = /[<>]|&lt;|&gt;|%3C|%3E/i;
            var inputs = document.querySelectorAll('#myform input[type="text"]');

            for (var i = 0; i < inputs.length; i++) {
                if (invalidChars.test(inputs[i].value)) {
                    alert('Caratteri < e > non sono consentiti.');
...
<body>
    ...
    <div id="main" class="clear">
        ...
        <form action="../catalogo" method="post" id="myform" onsubmit="return validateInput(event)">
