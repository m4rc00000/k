<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="it.unisa.model.*, java.util.*, java.util.regex.*"%>

<%
    // Recupera il parametro page dalla richiesta
    String page = request.getParameter("page");

    // Definisce una lista di pagine valide (whitelist)
    List<String> validPages = Arrays.asList("Home.jsp", "Ps5.jsp", "XboxSeries.jsp", "Switch.jsp", "Ps4.jsp", "XboxOne.jsp", "error.jsp");

    // Verifica se la pagina richiesta è nella lista delle pagine valide
    if (page != null && validPages.contains(page)) {
        // Prosegue con la logica dell'applicazione
...
<%
        ...
        // Reindirizza a una pagina di errore o pagina sicura se il parametro page non è valido
