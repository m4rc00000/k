...
<%
    ...
    List<String> validPages = Arrays.asList("Home.jsp", "Ps5.jsp", "XboxSeries.jsp", "Switch.jsp", "Ps4.jsp", "XboxOne.jsp");

    // Ottenere il parametro 'page'
    String pages = request.getParameter("page");

    // Controllare se il parametro 'page' è nella whitelist
    if (pages != null && !validPages.contains(pages)) {
        // Se il parametro 'page' non è valido, reindirizzare ad una pagina di errore
