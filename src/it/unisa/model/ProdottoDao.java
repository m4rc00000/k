...
public class ProdottoDao implements ProdottoDaoInterfaccia{
	...
	public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
	    ...
	    // Lista delle colonne accettabili
	    List<String> validColumns = Arrays.asList("ID_PRODOTTO", "NOME", "PIATTAFORMA", "DESCRIZIONE", "PREZZO", "QUANTITA", "GENERE", "DATA_USCITA", "IN_VENDITA", "IVA", "IMMAGINE", "DESCRIZIONE_DETTAGLIATA");
